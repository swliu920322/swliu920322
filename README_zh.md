# 🏗️ 刘圣伟 (Shengwei Liu) | 资深云架构师 & AI 工程师 | AZ-305 专家级架构师
...
资深软件工程师与云架构师，拥有 **10 年以上一线生产环境开发交付经验** 与 **人工智能硕士学位**（主攻企业级 RAG 检索增强生成与多智能体编排）。我兼具深厚的前端状态机逻辑控制底蕴和严谨的云平台工程架构能力，擅长在微软 Azure 上为大模型（LLM）等 AI 业务负载设计并部署安全、高可用且高度合规的专有网络边界。
